...
export default function Brigadeiro() {
    ...
    const itemsMap: { [key: string]: string } = {
        item1: "8 filés de merluza",
        item2: "1 pimentão \n(cortado em rodelas)",
        item3: "1 cebola (cortada em rodelas)",
        item4: "Orégano",
        item5: "4 batatas cruas (em rodelas, sem casca)",
        item6: "2 tomates (cortados em rodelas - as sementes ficam à preferência)",
        item7: "1/2 lata de molho de tomate de boa qualidade",
        item8: "Azeite para untar",
    ...
    const stepsMap: { [key: string]: string } = {
        ...
        step2: "Unta um refratário com azeite e faça uma camada de batata, em seguida arrume os filés sobre a batata.",
        step3: "Acrescente a cebola, o tomate, o pimentão, orégano a gosto, regue com o molho de tomate (1/2 lata).",
        step4: "Cubra com o restante das batatas. Cubra com papel alumínio e leve ao forno alto até que as batatas fiquem macias. ",
    ...
    const salvarListaDeCompras = async () => {
        ...
        const fileUri =
            FileSystem.documentDirectory + "lista_de_compras_merluza.txt";
        ...
        <View style={{ flex: 1 }}>
            <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
                <View style={styles.container}>
                    <Image
                        source={require("../assets/images/fundo_merluza.png")} // Certifique-se de que o caminho está correto
                        style={styles.decorativeImage}
                        resizeMode="contain"
                    />

                    <View style={styles.tituloContainer}>
                        <TouchableOpacity onPress={() => nav.navigate("jantar")}>
                            <Feather name="chevron-left" size={28} color="#000" />
                        </TouchableOpacity>
                        <Text style={styles.paragraph}>FILÉ DE MERLUZA COM BATATAS AO FORNO</Text>
                    </View>
