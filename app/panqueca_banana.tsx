...
export default function Brigadeiro() {
  ...
  const stepsMap: { [key: string]: string } = {
    step1:
      "No liquidificador, coloque os ovos e a banana. ",
    step2: "Bata tudo até que atinja a consistência homogênea.",
    step3: "Depois, coloque na frigideira (morna) uma concha da massa.",
    step4: "Em fogo baixo, espere alguns minutos e depois vire a massa para o outro lado para assar. ",
    step5: "Para rechear, coloque banana picada e o mel a gosto.",
  ...
  const salvarListaDeCompras = async () => {
    ...
    const fileUri =
      FileSystem.documentDirectory + "lista_de_compras_panquecabanana.txt";
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/fundo_panquecabanana.png")} // Certifique-se de que o caminho está correto
          ...
          <View style={styles.tituloContainer}>
            ...
            <Text style={styles.paragraph}>PANQUECA COM BANANA</Text>
          </View>
