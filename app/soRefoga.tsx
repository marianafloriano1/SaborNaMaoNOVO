...
export default function RefogadoLegumesOvo() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item3: "1 abobrinha pequena em cubinhos",
    item4: "1 cenoura média em cubinhos ou tirinhas",
    item5: "1 dente de alho picado",
    item6: "1/2 pimentão (qualquer cor) picado (opcional)",
    item7: "Azeite ou óleo para refogar",
    item8: "Sal e pimenta a gosto",
    item9: "Cheiro-verde para finalizar (opcional)",
  };

  const stepsMap: { [key: string]: string } = {
    step1:
      "Aqueça o azeite numa frigideira. Refogue a cebola e o alho até ficarem transparentes. Junte a cenoura, abobrinha e o pimentão. Cozinhe mexendo de vez em quando até os legumes ficarem macios, mas ainda firmes (uns 5-7 min).",
    step2: "Em uma tigela, bata os ovos com uma pitada de sal e pimenta.",
    step3:
      "Abaixe o fogo, despeje os ovos batidos sobre os legumes refogados e mexa delicadamente até os ovos cozinharem, formando um tipo de mexidão.",
    step4: "Ajuste o sal e a pimenta, salpique cheiro-verde e sirva.",
  };
  ...
  const salvarListaDeCompras = async () => {
    ...
    const fileUri =
      ...
      "lista_de_compras_refogado_legumes_ovo.txt";
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/imgRefodado.jpg")} // Ajuste para a imagem que quiser
          ...
          <View style={styles.tituloContainer}>
            ...
            <Text style={styles.paragraph}>Refogado de Legumes com Ovo</Text>
          </View>
