...
export default function Brigadeiro() {
    ...
    const itemsMap: { [key: string]: string } = {
        item1: "2 xícaras (chá) de farinha \nde trigo",
        item2: "5 colheres (sopa) de margarina",
        item3: "1 gema",
        item4: "2 colheres (sopa) de açúcar",
        item5: "1 e 1/2 lata de leite condensado",
      
    };

    const stepsMap: { [key: string]: string } = {
        step1:
            "Em uma tigela, misture a farinha, a margarina, a gema e o açúcar até ficar homogêneo.",
        step2: "Abra a massa com um rolo, e, forre o fundo e as laterais de forminhas para empada.",
        step3: "Coloque o leite condensado até um pouco mais do meio da forminha.",
        step4: "Leve ao forno médio, preaquecido, por 40 minutos ou até dourar levemente.",
        step5: "Retire do forno, deixe esfriar, desenforme e sirva.",
        };
    ...
    const salvarListaDeCompras = async () => {
        ...
        const fileUri =
            FileSystem.documentDirectory + "lista_de_compras_empadadoce.txt";
        ...
        <View style={{ flex: 1 }}>
            <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
                <View style={styles.container}>
                    <Image
                        source={require("../assets/images/fundo_empada.png")} // Certifique-se de que o caminho está correto
                    ...
                    <View style={styles.tituloContainer}>
                        ...
                        <Text style={styles.paragraph}>EMPADA DE LEITE CONDENSADO</Text>
                    </View>
