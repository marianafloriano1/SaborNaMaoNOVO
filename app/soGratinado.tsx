...
export default function soArForno() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item4: "Orégano ou cheiro-verde pra finalizar",
    item5: "Frango desfiado, presunto picado ou legumes (opcional)",
    item6: "1/2 xícara de queijo parmesão ralado (opcional)",
    item7: "1 xícara de queijo muçarela ralado",
    item8: "1/2 xícara de requeijão ou creme de leite",
    item9: "1 xícara de molho de tomate (ou o que sobrou do almoço)",
    item10:
      "3 xícaras de macarrão cozido (qualquer tipo – parafuso, penne, espaguete, etc.)",
  };
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/imgGrati.jpg")} // Certifique-se de que o caminho está correto
          ...
          <View style={styles.tituloContainer}>
            ...
            <Text style={styles.paragraph}>Gratinado de Macarrão</Text>
          </View>
