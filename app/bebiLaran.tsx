  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false}>
      <View style={styles.container}>
        <Image
          source={require("../assets/images/fundo_sucolaranja.png")}
...
Corte as laranjas ao meio e esprema usando um espremedor manual ou elétrico.
...
Coe o suco se quiser uma bebida sem bagaço.

Adoce a gosto com açúcar, mel ou outro adoçante (se necessário).
...
Sirva com gelo, se quiser o suco bem gelado.

Se quiser mais leve, adicione um pouco de água.
