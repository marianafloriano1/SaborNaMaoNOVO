...
export default function soArForno() {
  ...
  const stepsMap: { [key: string]: string } = {
    ...
    step2:
      "Em uma tigela, misture os ovos, o açúcar e o óleo até formar um creme.",
    step3: "Adicione as bananas amassadas e misture bem.",
    step4: "Acrescente a farinha de trigo aos poucos, mexendo até incorporar.",
    step5:
      "Junte o fermento e a canela, se for usar, misturando delicadamente.",
    step6:
      "Despeje a massa na forma e leve ao forno por cerca de 35 a 40 minutos ou até o palito sair limpo.",
    step7: "Deixe esfriar antes de servir. Fica ótimo com café!",
  };
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/imgboloBan.jpg")} // Certifique-se de que o caminho está correto
