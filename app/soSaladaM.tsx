...
export default function soArForno() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "1/2 xícara de ervilha",
    item2: "1/2 xícara de milho verde",
    item3: "1/2 cenoura ralada ou em tirinhas",
    item4: "1/2 xícara de maionese",
    item5: "Sal e pimenta a gosto",
    item6: "Azeitona picada (opcional)",
    item7:
      "2 colheres de sopa de creme de leite ou iogurte natural (opcional, pra deixar mais leve)",
    item8: "1/2 xícara de queijo picado (muçarela, prato, minas)",
    item9: "1/2 xícara de presunto picado (ou frango, atum, etc.)",
    item10: "3 xícaras de macarrão cozido (parafuso, espaguete, o que tiver)",
  };

  const stepsMap: { [key: string]: string } = {
    step1:
      "Em uma tigela, misture a maionese com o creme de leite (ou iogurte), tempere com sal, pimenta e cheiro-verde.",
    step2:
      "Em uma travessa grande, junte o macarrão cozido com o presunto, queijo, milho, ervilha, cenoura, azeitona (se usar) e o molho preparado.",
    step3: "Misture tudo muito bem.",
    step4: "Leve à geladeira por pelo menos 30 minutos.",
  };
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/imgMaionese.jpg")} // Certifique-se de que o caminho está correto
          ...
          <View style={styles.tituloContainer}>
            ...
            <Text style={styles.paragraph}>Salada Fria de Macarrão</Text>
          </View>
