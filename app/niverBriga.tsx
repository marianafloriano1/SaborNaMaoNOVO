...
export default function App() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item5:
      "2 colheres (sopa) de chocolate em pó (ou 3 de achocolatado, se preferir mais doce)",
  };
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/fundo_briga.png")}
          ...
          <TouchableOpacity onPress={() => toggleCheck("step1")}>
            <Text style={styles.topicos}>
              ...
              chocolate em pó. Misture bem antes de levar ao fogo.
            </Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => toggleCheck("step2")}>
            <Text style={styles.topicos}>
              ...
              Cozinhe em fogo baixo, mexendo sempre (sem parar), até a mistura
              desgrudar do fundo da panela — cerca de 10 a 12 minutos. O ponto
              certo é quando você passa a espátula e vê o fundo da panela.
            </Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => toggleCheck("step3")}>
            <Text style={styles.topicos}>
              ...
              completamente antes de enrolar.
            </Text>
          </TouchableOpacity>
