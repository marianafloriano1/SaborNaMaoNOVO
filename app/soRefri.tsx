...
export default function soArForno() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item4: "1 xícara de refrigerante \n(guaraná, laranja ou limão)",
  ...
  const stepsMap: { [key: string]: string } = {
    ...
    step3: "Adicione o óleo e o refrigerante, misturando bem.",
    step4: "Acrescente a farinha de trigo aos poucos, mexendo até incorporar.",
    step5: "Por último, adicione o fermento e misture delicadamente.",
    step6:
      "Despeje a massa na forma e leve ao forno por 35 a 40 minutos, ou até o palito sair limpo.",
    step7:
      "Espere esfriar antes de desenformar. Sirva simples ou com cobertura de sua preferência.",
  };
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/imgBoloCoca.jpg")} // Certifique-se de que o caminho está correto
          ...
          <View style={styles.tituloContainer}>
            ...
            <Text style={styles.paragraph}>Bolo com Refrigerante </Text>
          </View>
