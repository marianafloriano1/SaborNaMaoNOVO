...
export default function Brigadeiro() {
    ...
    const itemsMap: { [key: string]: string } = {
        item1: "2 bifes",
        item2: "1 cebola grande picada em \nrodelas",
        item3: "Sal a gosto",
        item4: "2 cabeças de alho",
        item5: "4 colheres de maionese",
        item6: "1/2 xícara de água",
    ...
    const stepsMap: { [key: string]: string } = {
        ...
        step2: "Após resguarde os bifes em um refratário ou travessa.",
        step3: "Na mesma panela dos bifes doure a cebola picada em rodelas, adicione o alho, após adicione a água.",
        step4: "Deixe cozinhar um pouco, até a cebola amolecer. ",
        step5: "Após feito isso adicione a maionese e deixe engrossar. ",
        step6: "Acrescente em cima dos bifes o creme com as cebolas e está pronto. ",
    ...
    const salvarListaDeCompras = async () => {
        ...
        const fileUri =
            FileSystem.documentDirectory + "lista_de_compras_bife_acebolado.txt";
        ...
        <View style={{ flex: 1 }}>
            <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
                <View style={styles.container}>
                    <Image
                        source={require("../assets/images/fundo_bife.png")} // Certifique-se de que o caminho está correto
                    ...
                    <View style={styles.tituloContainer}>
                        ...
                        <Text style={styles.paragraph}>BIFE ACEBOLADO COM MOLHO DE MAIONESE</Text>
                    </View>
