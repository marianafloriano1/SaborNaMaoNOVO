...
export default function soArForno() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "1 colher (chá) de sal",
    item2: "2 dentes de alho picados",
    item3: "3 colheres (sopa) de manteiga",
    item4: "1 colher (sopa) de salsinha picada",
    item5: "1 pão francês ou baguete",
    item6: "Queijo ralado a gosto (opcional)",
  };
  ...
  const stepsMap: { [key: string]: string } = {
    ...
    step4:
      "Passe a pasta de alho entre as fatias e, se quiser, adicione queijo ralado.",
    step5: "Enrole o pão em papel alumínio e leve ao forno por 15 minutos.",
    step6: "Retire o papel alumínio e asse por mais 5 minutos para dourar.",
    step7: "Sirva quente.",
  };
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/imgPaoAlho.jpg")} // Certifique-se de que o caminho está correto
          ...
          <View style={styles.tituloContainer}>
            ...
            <Text style={styles.paragraph}>Pão de Alho</Text>
          </View>
