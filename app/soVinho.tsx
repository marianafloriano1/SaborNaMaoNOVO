...
export default function soArForno() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item4: "500g de carne em cubos (acém, coxão mole ou patinho)",
    item5: "1 cebola picada",
    item6: "2 dentes de alho picados",
    item7: "1 colher (sopa) de farinha de trigo",
    item8: "1 xícara de vinho tinto seco",
    item9: "1 xícara de caldo de carne ou água quente",
  };

  const stepsMap: { [key: string]: string } = {
    step1: "Tempere a carne com sal e pimenta.",
    step2:
      "Aqueça o óleo em uma panela e doure bem os cubos de carne. Retire e reserve.",
    step3: "Na mesma panela, refogue a cebola e o alho até dourarem.",
    step4:
      "Adicione a farinha de trigo e mexa por 1 minuto para engrossar o molho.",
    step5:
      "Volte a carne para a panela, junte o vinho tinto e o caldo de carne.",
    step6:
      "Mexa bem, tampe a panela e cozinhe em fogo baixo por cerca de 30 a 40 minutos, ou até a carne ficar macia.",
    step7:
      "Ajuste o sal e a pimenta se necessário e sirva com arroz, purê ou pão.",
  };
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/imgCarVinho.jpg")} // Certifique-se de que o caminho está correto
          ...
          <View style={styles.tituloContainer}>
            ...
            <Text style={styles.paragraph}>Carne ao Molho de Vinho Tinto</Text>
          </View>
