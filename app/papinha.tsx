    ...
    <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
      <View style={styles.container}>
        ...
        <View style={styles.tituloContainer}>
          ...
          <Text style={styles.paragraph}>Papinha de{"\n"}Carne, Batata e Abóbora</Text>
        </View>
        ...
        <TouchableOpacity onPress={() => toggleCheck('step3')}>
          <Text style={styles.topicos}>
            {checkedItems.step3 ? <Text style={styles.check}>✓ </Text> : <Text style={styles.bolinha}>⚪ </Text>}
             Cubra com água, tampe a panela e cozinhe até que todos os ingredientes estejam macios.
          </Text>
        </TouchableOpacity>
        ...
        <Text style={[styles.topicos, { left: 44, width: 290, marginBottom: 0 }]}>
          Para saber a consistência ideal dos alimentos para cada fase de seu bebê, consulte um médico pediatra ou nutricionista.
        </Text>
        <Text style={[styles.topicos, { left: 44, width: 290, marginBottom: 0 }]}>
