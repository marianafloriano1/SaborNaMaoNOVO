    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          ...
          <Text
            style={[styles.topicos, { left: 44, width: 290, marginBottom: 0 }]}
          >
            Para saber a consistência ideal dos alimentos para cada fase de seu
            bebê, consulte um médico pediatra ou nutricionista.
          </Text>
          <Text
            style={[styles.topicos, { left: 44, width: 290, marginBottom: 0 }]}
          >
