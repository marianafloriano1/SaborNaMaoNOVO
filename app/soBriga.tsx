...
export default function soArForno() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item3: "150g de chocolate picado (sobras variadas)",
    item4: "Chocolate granulado para enrolar (opcional)",
  };

  const stepsMap: { [key: string]: string } = {
    step1: "Em uma panela, coloque a manteiga e o leite condensado.",
    step2: "Adicione o chocolate picado e leve ao fogo baixo.",
    step3:
      "Mexa sem parar até derreter completamente o chocolate e o brigadeiro começar a desgrudar do fundo da panela.",
    step4: "Desligue o fogo e deixe esfriar em um prato untado.",
    step5: "Se desejar enrolar, modele os brigadeiros e passe no granulado.",
    step6: "Também pode ser servido em copinhos como brigadeiro de colher.",
  };
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/imgBrigadei.jpg")} // Certifique-se de que o caminho está correto
          ...
          <View style={styles.tituloContainer}>
            ...
            <Text style={styles.paragraph}>
              Brigadeiro com Sobras de Chocolatee
            </Text>
          </View>
