...
export default function soArForno() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item3: "1 colher (sopa) de açúcar",
    item4: "3 colheres (sopa) de farinha de trigo",
    item5: "1 colher (chá) de fermento em pó",
    item6: "Frutas picadas a gosto (banana, morango, maçã)",
    item7: "Manteiga ou óleo para untar",
  };

  const stepsMap: { [key: string]: string } = {
    step1: "Em uma tigela, bata o ovo, o leite e o açúcar até misturar bem.",
    step2:
      "Adicione a farinha de trigo e o fermento e misture até formar uma massa lisa.",
    step3: "Aqueça uma frigideira antiaderente e unte com manteiga ou óleo.",
    step4: "Despeje uma concha pequena da massa na frigideira quente.",
    step5: "Espalhe algumas frutas picadas sobre a massa na frigideira.",
    step6:
      "Cozinhe até formar bolhas na superfície, vire e doure o outro lado.",
    step7: "Repita com o restante da massa e sirva quente.",
  };
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/imgPanqFruta.jpg")} // Certifique-se de que o caminho está correto
            style={styles.decorativeImage}
            resizeMode="contain"
          />

          <View style={styles.tituloContainer}>
            <TouchableOpacity onPress={() => nav.navigate("soboroFruta")}>
              <Feather name="chevron-left" size={28} color="#000" />
            </TouchableOpacity>
            <Text style={styles.paragraph}>Panqueca de Frutas</Text>
          </View>
