      ...
      <View style={styles.container}>
        ...
        <TouchableOpacity onPress={() => toggleCheck("step1")}>
          <Text style={styles.topicos}>
            ...
            Pré-aqueça o forno a 180 °C e unte uma forma média com manteiga e
            farinha ou chocolate em pó.
          </Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => toggleCheck("step2")}>
          <Text style={styles.topicos}>
            ...
            No liquidificador ou na batedeira, bata os ovos, o açúcar, o óleo e
            o leite até ficar homogêneo.
          </Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => toggleCheck("step3")}>
          <Text style={styles.topicos}>
            ...
            Acrescente o chocolate, a farinha e, por último, o fermento. Misture
            até incorporar bem.
          </Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => toggleCheck("step4")}>
          <Text style={styles.topicos}>
            ...
            Despeje a massa na forma e leve ao forno por 35 a 40 minutos. Faça o
            teste do palito: se sair limpo, está pronto!
          </Text>
        </TouchableOpacity>
