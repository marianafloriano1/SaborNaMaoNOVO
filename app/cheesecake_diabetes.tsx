...
export default function Brigadeiro() {
  ...
  const stepsMap: { [key: string]: string } = {
    ...
    const salvarListaDeCompras = async () => {
        ...
        const fileUri =
            FileSystem.documentDirectory + "lista_de_compras_cheesecake.txt";
        ...
        <View style={{ flex: 1 }}>
            <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
                <View style={styles.container}>
                    <Image
                        source={require("../assets/images/fundo_cheesecake.png")} // Certifique-se de que o caminho está correto
