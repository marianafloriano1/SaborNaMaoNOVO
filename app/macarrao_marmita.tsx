...
export default function Brigadeiro() {
    ...
    const itemsMap: { [key: string]: string } = {
        item1: "200g de macarrão \n(parafuso ou penne)",
        item2: "1 lata de sardinha",
        item3: "1 tomate picado",
        item4: "1/2 cebola picada",
        item5: "1/2 cenoura ralada",
        item6: "1/2 abobrinha ralada",
        item7: "Sal e temperos a gosto",
    };

    const stepsMap: { [key: string]: string } = {
        step1:
            "Cozinhe o macarrão conforme as instruções da embalagem.",
        step2: "Em uma panela, refogue a cebola, adicione o tomate, cenoura, abobrinha e deixe amolecer.",
        step3: "Junte a sardinha (com um pouco do óleo ou sem, como preferir), desfie e misture bem.",
        step4: "Adicione o macarrão cozido, misture e acerte o sal.",
    ...
    const salvarListaDeCompras = async () => {
        ...
        const fileUri =
            FileSystem.documentDirectory + "lista_de_compras_macarraocomsardinha.txt";
        ...
        <View style={{ flex: 1 }}>
            <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
                <View style={styles.container}>
                    <Image
                        source={require("../assets/images/fundo_macarrao_marmita.png")} // Certifique-se de que o caminho está correto
                    ...
                    <View style={styles.tituloContainer}>
                        ...
                        <Text style={styles.paragraph}>MACARRÃO COM SARDINHA</Text>
                    </View>
