...
export default function PanquecaSobras() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "Pimenta a gosto ",
    item2: "1 ovo",
    item3: "Sal a gosto",
    item4: "1/2 xícara de leite (ou água, ou leite vegetal)",
    item5: "1/2 xícara de farinha de trigo",
    item6: "1 xícara de sobras de legumes cozidos picados",
    item7: "Ervas frescas ou secas (salsa, cebolinha, orégano) - opcional",
    item8: "Óleo ou manteiga para untar a frigideira",
  };

  const stepsMap: { [key: string]: string } = {
    step1: "Em uma tigela, bata o ovo com o leite até ficar homogêneo.",
    step2:
      "Adicione a farinha, o sal, a pimenta e as ervas. Misture até formar uma massa lisa, nem muito grossa nem muito líquida.",
    step3: "Incorpore as sobras de legumes picados delicadamente à massa.",
    step4:
      "Aqueça uma frigideira antiaderente e unte com um pouco de óleo ou manteiga.",
    step5:
      "Coloque uma concha da massa na frigideira e espalhe formando um círculo médio. Cozinhe em fogo médio até as bordas firmarem e a parte de baixo dourar (2-3 minutos).",
    step6:
      "Vire a panqueca com cuidado e cozinhe o outro lado até dourar. Repita com o restante da massa. Sirva quente, puro ou com molho de sua preferência.",
  };
  ...
  const salvarListaDeCompras = async () => {
    ...
    const fileUri =
      FileSystem.documentDirectory + "lista_de_compras_panqueca_sobras.txt";
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/imgPanq.jpg")} // Troque para uma imagem que preferir
