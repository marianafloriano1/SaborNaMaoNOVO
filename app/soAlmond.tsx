...
export default function soArForno() {
  ...
  const stepsMap: { [key: string]: string } = {
    step1:
      "Misture a carne com os temperos, a cebola, alho, ovo e farinha. Amasse até dar liga. Modele bolinhas (do tamanho que quiser).",
    step2:
      "Em uma frigideira grande, aqueça um fio de óleo e doure as almôndegas de todos os lados (não precisa cozinhar por dentro, só selar).",
    step3:
      " Fazer o molho: Em outra panela ou na mesma (retirando o excesso de óleo), refogue a cebola e o alho. Acrescente o molho de tomate, a água, o sal, pimenta, orégano e o açúcar. Cozinhe por 5 minutos.",
    step4:
      "Coloque as almôndegas dentro do molho. Tampe e cozinhe por uns 15 a 20 minutos, em fogo baixo, até elas cozinharem por dentro e o molho engrossar.",
  };
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/imgAlmon.jpg")} // Certifique-se de que o caminho está correto
          ...
          <View style={styles.tituloContainer}>
            ...
            <Text style={styles.paragraph}>Almôndegas ao Molho</Text>
          </View>
