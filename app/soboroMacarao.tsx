      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.branco}>
          <View>
            <TouchableOpacity
              style={styles.card}
              onPress={() => nav.navigate("soGratinado")}
            >
              <ImageBackground
                source={require("../assets/images/soboroMaca.jpg")} // Imagem de fundo
          ...
          <View>
            <TouchableOpacity
              style={styles.cardD}
              onPress={() => nav.navigate("soTortaMacar")}
            >
              <ImageBackground
                source={require("../assets/images/soboroMaca.jpg")} // Imagem de fundo
                style={styles.backgroundImage}
                resizeMode="cover"
              ></ImageBackground>
              <Text style={styles.texto}>Torta Salgada de Macarrão</Text>
              <Image
                source={{
                  uri: "https://images.pexels.com/photos/2471438/pexels-photo-2471438.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
                }}
                style={styles.cardImage}
              />
            </TouchableOpacity>
          ...
          <View>
            <TouchableOpacity
              style={styles.card}
              onPress={() => nav.navigate("soSaladaM")}
            >
              <ImageBackground
                source={require("../assets/images/soboroMaca.jpg")} // Imagem de fundo
                style={styles.backgroundImage}
