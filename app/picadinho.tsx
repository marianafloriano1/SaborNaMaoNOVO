...
export default function Brigadeiro() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "1 colher (sopa) de óleo \nou azeite",
    item2: "500g de coxão mole ou aranha do contrafilé em cubos",
    item3: "Sal e pimenta-do-reino a gosto",
    item4: "2 dentes de alho picados",
    item5: "4 colheres (sopa) de mostarda amarela",
    item6: "2 colheres (sopa) de maionese",
    item7: "4 colheres (sopa) de água",
    item8: "1 xícara (chá) de rúcula picada",
  ...
  const stepsMap: { [key: string]: string } = {
    step1:
      "Aqueça uma frigideira larga com o óleo, em fogo alto, e doure a carne em 2 etapas.",
    step2: "Retire, tempere com sal, pimenta e mantenha aquecido em uma travessa.",
    step3: "Na mesma frigideira, acrescente o alho e mexa até dourar.",
    step4: "Junte a mostarda, a maionese, a água, sal, pimenta e misture. ",
    step5: "Se necessário, acerte o sal. ",
    step6: "Despeje sobre a carne reservada, polvilhe com a rúcula picada e sirva.",
  };
  ...
  const salvarListaDeCompras = async () => {
    ...
    const fileUri =
      FileSystem.documentDirectory + "lista_de_compras_picadinho.txt";
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/fundo_picadinho.png")} // Certifique-se de que o caminho está correto
          ...
          <View style={styles.tituloContainer}>
            ...
            <Text style={styles.paragraph}>PICADINHO DE CARNE COM RÚCULA</Text>
          </View>
