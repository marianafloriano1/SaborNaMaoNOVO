...
export default function Brigadeiro() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "1 colher (café) de páprica",
    item2: "4 fatias de queijo mussarela",
    item3: "2 fatias de pão da sua preferência",
    item4: "3 colheres (sopa) de manteiga com sal",

  };

  const stepsMap: { [key: string]: string } = {
    step1:
      "Em um recipiente, coloque a páprica e a manteiga. Mexa bem até atingir a consistência de um creme homogêneo.",
    step2: "Depois, passe o creme nas fatias de pão, coloque o queijo e leve até a frigideira para fritar.",
    step3: "Por último, vire as fatias do outro lado para dourar ou até que o queijo derreta completamente.",
  ...
  const salvarListaDeCompras = async () => {
    ...
    const fileUri =
      FileSystem.documentDirectory + "lista_de_compras_queijoquente.txt";
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/fundo_queijoquente.png")} // Certifique-se de que o caminho está correto
          ...
          <View style={styles.tituloContainer}>
            ...
            <Text style={styles.paragraph}>QUEIJO QUENTE COM MANTEIGA E PAPRICA</Text>
          </View>
