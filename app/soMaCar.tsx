...
export default function soArForno() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item2: "300 g de carne moída",
    item3: "2 dentes de alho picados",
    item4: "Sal e pimenta a gosto",
    item5: "Azeite ou óleo para refogar",
    item6: "Queijo ralado para servir (opcional)",
    item7: "250 g de macarrão (qualquer tipo)",
    item8: "2 tomates picados ou 1 lata de molho de tomate",
  };

  const stepsMap: { [key: string]: string } = {
    step1:
      "Em água fervente com sal, cozinhe o macarrão conforme o tempo da embalagem. Escorra e reserve.",
    step2:
      "Em uma panela, aqueça o azeite e refogue a cebola e o alho até dourarem. Junte a carne moída e cozinhe até ela perder a cor rosada.",
    step3:
      "Acrescente o tomate picado ou o molho de tomate, tempere com sal e pimenta. Deixe cozinhar por uns 10 minutos, mexendo de vez em quando.",
    step4: "Junte o macarrão cozido ao molho de carne e misture bem.",
  };
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/imgMCarne.jpg")} // Certifique-se de que o caminho está correto
          ...
          <View style={styles.tituloContainer}>
            ...
            <Text style={styles.paragraph}>Macarrão com Carne Moída</Text>
          </View>
