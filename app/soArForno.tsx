...
export default function soArForno() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item2: "Azeite para refogar",
    item3: "Sal e pimenta a gosto",
    item4: "2 dentes de alho picados",
    item5: "1 tomate picado ou 1/2 lata de molho de tomate",
    item6: "1 caixinha de creme de leite (200g)",
    item7: "1 copo de requeijão (opcional)",
    item8: "1 xícara de queijo muçarela ralado",
  };

  const stepsMap: { [key: string]: string } = {
    step1: "Em uma panela, refogue cebola e alho no azeite até dourar.",
    step2:
      "Se quiser, junte o que tiver (frango desfiado, legumes, milho, ervilha).",
    step3: "Acrescente o arroz pronto (sobra) e misture bem.",
    step4:
      "Adicione creme de leite e requeijão (se tiver) para dar cremosidade. Tempere com sal e pimenta.",
    step5:
      "Transfira para um refratário, cubra com queijo muçarela e parmesão ralado.",
    step6:
      "Leve ao forno pré-aquecido a 180ºC por cerca de 20 minutos, até gratinar.",
  };
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/imgArroz.jpg")} // Certifique-se de que o caminho está correto
