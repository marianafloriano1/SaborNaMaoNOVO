...
export default function SaladaLegumes() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item2: "1 tomate médio picado ",
    item3: "1/2 xícara de milho verde",
    item4: " 1/2 pimentão (qualquer cor) picado",
  ...
  const stepsMap: { [key: string]: string } = {
    step1: "Misture todos os legumes picados e ralados em uma tigela grande.",
    step2: "Adicione a salsinha e cebolinha picadas.",
    step3: "Tempere com o suco de limão, azeite, sal e pimenta a gosto.",
    step4:
      "Misture bem e deixe na geladeira por pelo menos 30 minutos antes de servir para pegar sabor.",
  };
  ...
  const salvarListaDeCompras = async () => {
    ...
    const fileUri =
      FileSystem.documentDirectory + "lista_de_compras_salada_legumes.txt";
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/imgSaLegu.jpg")} // Ajuste para a imagem que preferir
          ...
          <View style={styles.tituloContainer}>
            ...
            <Text style={styles.paragraph}>Salada de Legumes</Text>
          </View>
