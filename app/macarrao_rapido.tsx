...
export default function Brigadeiro() {
    ...
    const itemsMap: { [key: string]: string } = {
        item1: "250 g de macarrão de sua \npreferência",
        item2: "meia colher (sopa) de sal",
        item3: "1 colher (sopa) de margarina",
        item4: "meia colher (sopa) de farinha de trigo",
        item5: "1 e meia xícara (chá) de leite ",
        item6: "1 colher (chá) de MAGGI® Fondor",
        item7: "2 colheres (sopa) de requeijão",
        item8: "meia xícara (chá) de espinafre aferventado e picado",
    ...
    const stepsMap: { [key: string]: string } = {
        ...
        step2: "Enquanto isso prepare o molho.",
        step3: "Em uma panela derreta a margarina, acrescente e farinha e misture bem.",
        step4: "Junte o leite aos poucos, mexendo sempre, para não formar grumos.",
        step5: "Tempere com o MAGGI Fondor e cozinhe em fogo baixo, sem parar de mexer, até começar a engrossar.",
        step6: "Junte o requeijão, o espinafre e deixe o requeijão derreter.",
        step7: "Escorra o macarrão, coloque em um recipiente, cubra com o molho e sirva a seguir.",
    };
    ...
    const salvarListaDeCompras = async () => {
        ...
        const fileUri =
            FileSystem.documentDirectory + "lista_de_compras_macarrao.txt";
        ...
        <View style={{ flex: 1 }}>
            <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
                <View style={styles.container}>
                    <Image
                        source={require("../assets/images/fundo_macarrao_rapido.png")} // Certifique-se de que o caminho está correto
                    ...
                    <View style={styles.tituloContainer}>
                        ...
                        <Text style={styles.paragraph}>MACARRÃO COM MOLHO BRANCO E ESPINAFRE</Text>
                    </View>
