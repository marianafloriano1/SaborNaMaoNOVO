...
export default function Brigadeiro() {
  ...
  const stepsMap: { [key: string]: string } = {
    ...
    const salvarListaDeCompras = async () => {
        ...
        const fileUri =
            FileSystem.documentDirectory + "lista_de_compras_churros.txt";
        ...
        <View style={{ flex: 1 }}>
            <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
                <View style={styles.container}>
                    <Image
                        source={require("../assets/images/fundo_churros.png")} // Certifique-se de que o caminho está correto
                    ...
                    <View style={styles.tituloContainer}>
                        ...
                        <Text style={styles.paragraph}>CHURROS</Text>
                    </View>
