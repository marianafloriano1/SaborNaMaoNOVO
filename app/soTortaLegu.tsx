...
export default function soArForno() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item3: "1/2 xícara de óleo",
    item4: "2 xícaras de farinha de trigo",
    item5: "1 colher (sopa) de fermento em pó",
    item6:
      "2 xícaras de legumes cozidos e picados (cenoura, ervilha, milho, abobrinha)",
    item7: "1/2 cebola picada",
    item8: "Sal e pimenta a gosto",
  };

  const stepsMap: { [key: string]: string } = {
    step1:
      "No liquidificador, bata os ovos, o leite e o óleo até misturar bem.",
    step2:
      "Acrescente a farinha de trigo, o fermento, o sal e a pimenta. Bata só para incorporar.",
    step3: "Em uma tigela, misture os legumes cozidos e a cebola picada.",
    step4:
      "Despeje metade da massa em uma forma untada, espalhe os legumes por cima e cubra com o restante da massa.",
    step5:
      "Leve ao forno pré-aquecido a 180°C por cerca de 35-40 minutos ou até dourar e firmar. Deixe esfriar um pouco antes de desenformar.",
  };
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/imgTortaL.jpg")} // Certifique-se de que o caminho está correto
            style={styles.decorativeImage}
            resizeMode="contain"
          />

          <View style={styles.tituloContainer}>
            <TouchableOpacity onPress={() => nav.navigate("soboroLegu")}>
