...
export default function soArForno() {
  ...
  const itemsMap: { [key: string]: string } = {
    ...
    item3: "1 colher de chá de açúcar",
    item4: "1 colher de chá de shoyu (opcional)",
    item5: "1 colher de sopa de açúcar",
    item6: "2 colheres de sopa de shoyu",
    item7: "300 g de carne moída (boi, frango ou porco)",
    item8: "Um pedaço pequeno de gengibre ralado (opcional)",
    item9: "1 colher de sopa de mirin (ou um pouco mais de açúcar)",
    item10:
      "1 colher de sopa de saquê culinário (ou vinagre branco, se não tiver)",
  };

  const stepsMap: { [key: string]: string } = {
    step1:
      "Numa frigideira, coloque a carne moída com o shoyu, açúcar, saquê, mirin e gengibre. Cozinhe em fogo médio, mexendo sempre, até secar bem e a carne ficar soltinha e brilhante.",
    step2:
      "Em outra frigideira, bata os ovos com o açúcar, sal e shoyu. Cozinhe mexendo sem parar, até virar um ovo mexido bem soltinho.",
    step3:
      "Em uma tigela, coloque uma porção de arroz cozido quente. Por cima, coloque a carne moída de um lado e o ovo do outro, lado a lado, como uma “meia-lua” de cada.",
  };
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/imgDon.jpg")} // Certifique-se de que o caminho está correto
            style={styles.decorativeImage}
            resizeMode="contain"
          />

          <View style={styles.tituloContainer}>
            <TouchableOpacity onPress={() => nav.navigate("soboroCarne")}>
              <Feather name="chevron-left" size={28} color="#000" />
            </TouchableOpacity>
            <Text style={styles.paragraph}>Soboro Don</Text>
          </View>
