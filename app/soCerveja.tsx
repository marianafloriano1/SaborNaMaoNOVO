...
export default function soArForno() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "Sal a gosto",
    item2: "Pimenta a gosto",
    item3: "2 colheres (sopa) de óleo",
    item4: "1kg de frango ou costelinha suína",
    item5: "3 dentes de alho picados",
    item6: "1 cebola grande picada",
    item7: "1 colher (sopa) de mostarda",
    item8: "1 colher (sopa) de molho inglês",
    item9: "1 lata (350ml) de cerveja clara",
  };

  const stepsMap: { [key: string]: string } = {
    step1: "Tempere o frango ou costelinha com sal e pimenta.",
    step2: "Aqueça o óleo em uma panela e doure bem a carne de todos os lados.",
    step3: "Adicione a cebola e o alho, refogando até dourar.",
    step4:
      "Junte a mostarda e o molho inglês, mexendo bem para envolver toda a carne.",
    step5: "Adicione a cerveja e misture.",
    step6:
      "Tampe a panela e cozinhe em fogo baixo por 30 a 40 minutos, até a carne ficar bem macia e o molho reduzir.",
    step7:
      "Se desejar o molho mais espesso, cozinhe sem tampa nos minutos finais.",
    step8: "Sirva com arroz branco, purê ou batatas assadas.",
  };
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/imgCarCerveja.jpg")} // Certifique-se de que o caminho está correto
            style={styles.decorativeImage}
            resizeMode="contain"
          />

          <View style={styles.tituloContainer}>
            <TouchableOpacity onPress={() => nav.navigate("soboroBebi")}>
              <Feather name="chevron-left" size={28} color="#000" />
            </TouchableOpacity>
            <Text style={styles.paragraph}>
              Frango ou Costelinha na Cerveja
            </Text>
          </View>
