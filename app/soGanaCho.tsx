...
export default function soArForno() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "100ml de \ncreme de leite ",
    item2: "200g de chocolate picado \n(sobras variadas)",
  };

  const stepsMap: { [key: string]: string } = {
    step1: "Pique o chocolate em pedaços pequenos e coloque em um recipiente.",
    step2: "Aqueça o creme de leite até quase ferver, mas sem deixar ferver.",
    step3:
      "Despeje o creme de leite quente sobre o chocolate e aguarde 1 a 2 minutos.",
    step4:
      "Misture bem até obter um creme liso e brilhante. Se necessário, aqueça por mais 10 segundos no micro-ondas.",
    step5:
      "Utilize imediatamente para cobertura ou leve à geladeira para firmar, se for usar como recheio.",
  };
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/imgGana.jpg")} // Certifique-se de que o caminho está correto
          ...
          <View style={styles.tituloContainer}>
            ...
            <Text style={styles.paragraph}>Ganache de Chocolate</Text>
          </View>
