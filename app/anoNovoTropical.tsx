...
export default function App() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "1/2 abacaxi cortado em cubos",
    item2: "1 manga firme cortada em cubos",
    item3: "2 bananas cortadas em rodelas grossas",
    item4: "Morangos inteiros (sem folhas)",
    item5: "2 colheres (sopa) de manteiga",
    item6: "4 colheres (sopa) de açúcar mascavo ou demerara",
    item7: "1 colher (chá) de canela (opcional)",
    item8: "Palitos de churrasco",
  };
      ...
      <View style={styles.container}>
        ...
        <TouchableOpacity onPress={() => toggleCheck("step2")}>
          <Text style={styles.topicos}>
            ...
            Em uma frigideira grande ou chapa, derreta a manteiga. Acrescente o
            açúcar e a canela, mexa até formar um caramelo leve. Coloque os
            espetinhos na frigideira e vá virando até as frutas ficarem
            levemente douradas e caramelizadas.
          </Text>
        </TouchableOpacity>
