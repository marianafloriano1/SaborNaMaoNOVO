...
export default function Brigadeiro() {
    ...
    const itemsMap: { [key: string]: string } = {
        item1: "1 baguete pequena",
        item2: "1 dente de alho",
        item3: "2 tomates italianos grandes e bem maduros",
        item4: "2 ramos de manjericão",
        item5: "Azeite a gosto",
    ...
    const stepsMap: { [key: string]: string } = {
        ...
        step2: "Descasque o dente de alho e esfregue-o nas fatias de pão.",
        step3: "Coloque as fatias em uma assadeira, regue elas com um fio de azeite e leve-as ao forno preaquecido a 180ºC por cerca de 10 minutos ou até que fiquem crocantes e levemente douradas. Reserve.",
        step4: "Lave os tomates, corte-os ao meio e retire as sementes.",
        step5: "Corte os tomates em cubos, cerca de 0,5 cm.",
        step6: "Em uma tigela, coloque os tomates em cubos, as folhas de manjericão, um generoso fio de azeite, o sal e a pimenta. Misture delicadamente.",
        step7: "Coloque uma porção desse tomate temperado por cima de cada fatia das torradas, regue com mais um fio de azeite e sirva. Bom apetite!.",
    ...
    const salvarListaDeCompras = async () => {
        ...
        const fileUri =
            FileSystem.documentDirectory + "lista_de_compras_brusqueta.txt";
        ...
        <View style={{ flex: 1 }}>
            <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
                <View style={styles.container}>
                    <Image
                        source={require("../assets/images/fundo_brusqueta.png")} // Certifique-se de que o caminho está correto
