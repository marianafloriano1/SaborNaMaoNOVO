...
export default function soArForno() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "1/2 xícara de açúcar",
    item2: "1 colher (sopa) de\n suco de limão",
    item3: "1 xícara de fruta picada\n (morango, manga, maçã, etc.)",
    item4: "Água (apenas se necessário para ajustar a textura)",
  };

  const stepsMap: { [key: string]: string } = {
    step1: "Coloque a fruta picada e o açúcar em uma panela pequena.",
    step2: "Leve ao fogo médio e mexa até a fruta começar a soltar líquido.",
    step3: "Adicione o suco de limão e continue cozinhando, mexendo sempre.",
    step4:
      "Amasse levemente a fruta com um garfo ou amassador, se desejar uma textura mais uniforme.",
    step5:
      "Cozinhe por 10 a 15 minutos, até engrossar e atingir a consistência de geleia.",
    step6:
      "Se necessário, adicione um pouquinho de água para ajustar a textura.",
    step7:
      "Deixe esfriar e armazene em pote limpo na geladeira por até 1 semana.",
  };
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/imgGeleia.jpg")} // Certifique-se de que o caminho está correto
          ...
          <View style={styles.tituloContainer}>
            ...
            <Text style={styles.paragraph}>Geleia Rápida de Frutas</Text>
          </View>
