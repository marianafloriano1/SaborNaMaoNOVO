...
export default function Brigadeiro() {
    ...
    const itemsMap: { [key: string]: string } = {
        item1: "2 ovos",
        item2: "1/2 xícara (chá) de açúcar",
        item3: "3 colheres (sopa) de manteiga ou margarina em temperatura ambiente",
        item4: "3 colheres (sopa) de leite",
        item5: "3 colheres (sopa) de achocolatado em pó",
        item6: "1 xícara (chá) de farinha de trigo",
    ...
    const stepsMap: { [key: string]: string } = {
        step1:
            "Em uma tigela, misture com uma colher de pau os ovos, o açúcar, a manteiga e o leite.",
        step2: "Adicione a farinha e o achocolatado peneirados e misture até homogeneizar.",
        step3: "Acrescente o fermento e misture delicadamente.",
        step4: "Despeje a massa até a metade da capacidade de uma caneca de 250ml e leve ao forno micro-ondas, em temperatura média, por 3 minutos.",
        step5: "Deixe descansar por 5 minutos e sirva.",
        };
    ...
    const salvarListaDeCompras = async () => {
        ...
        const fileUri =
            FileSystem.documentDirectory + "lista_de_compras_bolocaneca.txt";
        ...
        <View style={{ flex: 1 }}>
            <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
                <View style={styles.container}>
                    <Image
                        source={require("../assets/images/fundo_bolo.png")} // Certifique-se de que o caminho está correto
                        style={styles.decorativeImage}
                        resizeMode="contain"
                    />

                    <View style={styles.tituloContainer}>
                        <TouchableOpacity onPress={() => nav.navigate("doces")}>
