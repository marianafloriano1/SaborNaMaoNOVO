...
export default function soArForno() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "1 ovo",
    item2: "3 colheres (sopa) de leite",
    item3: "2 colheres (sopa) de açúcar",
    item4: "2 colheres (sopa) de chocolate em pó",
    item5: "4 colheres (sopa) de farinha de trigo",
    item6: "1 colher (sopa) de óleo ou manteiga",
    item7: "1/2 colher (chá) de fermento em pó",
    item8: "Pedacinhos de chocolate (opcional)",
  };

  const stepsMap: { [key: string]: string } = {
    step1:
      "Em um recipiente, misture o ovo, o leite, o açúcar e o óleo até ficar homogêneo.",
    step2: "Adicione o chocolate em pó e misture bem.",
    step3:
      "Acrescente a farinha de trigo e misture até incorporar completamente.",
    step4: "Adicione o fermento por último e mexa delicadamente.",
    step5: "Se quiser, misture pedacinhos de chocolate à massa.",
    step6: "Unte levemente uma frigideira antiaderente e aqueça em fogo baixo.",
    step7:
      "Despeje a massa na frigideira, tampe e cozinhe por cerca de 5-8 minutos ou até firmar e dourar por baixo.",
    step8:
      "Vire com cuidado e doure o outro lado por mais 2-3 minutos. Sirva morno.",
  };
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/imgPao.jpg")} // Certifique-se de que o caminho está correto
            style={styles.decorativeImage}
            resizeMode="contain"
          />

          <View style={styles.tituloContainer}>
            <TouchableOpacity onPress={() => nav.navigate("soboroChoco")}>
              <Feather name="chevron-left" size={28} color="#000" />
            </TouchableOpacity>
            <Text style={styles.paragraph}>Pão de Chocolate na Frigideira</Text>
          </View>
