...
export default function soArForno() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "500 g de carne moída",
    item2: "rap10",
    item3: "Alface picada",
    item4: "Tomate em cubinhos",
    item5: "Queijo ralado",
    item6: "Creme azedo ou requeijão (opcional)",
  };

  const stepsMap: { [key: string]: string } = {
    step1:
      "Aqueça um fio de azeite numa panela. Refogue a cebola e o alho até dourarem. Adicione a carne moída e cozinhe até ela dourar bem. Junte o tomate, os temperos (cominho, páprica, sal e pimenta) e cozinhe por mais 5 min, até secar o líquido.",
    step2:
      "Esquente as tortilhas rapidamente numa frigideira (30 segundos de cada lado) ou no micro-ondas cobertas com um pano úmido.",
    step3:
      "Recheie as tortilhas com carne moída. Adicione alface, tomate, queijo e o que mais quiser por cima.",
  };
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/imgTacos.jpg")} // Certifique-se de que o caminho está correto
          ...
          <View style={styles.tituloContainer}>
            ...
            <Text style={styles.paragraph}>Tacos de Carne Moída</Text>
          </View>
