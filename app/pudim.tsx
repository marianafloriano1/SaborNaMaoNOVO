...
export default function PudimAirFryer() {
    ...
    const stepsMap: { [key: string]: string } = {
        ...
        step3: "Adicione o leite e a essência de baunilha, e mexa até incorporar na mistura e reserve.",
        step4: "Em uma frigideira ou panela coloque o açúcar e deixa derreter.",
        step5: "Quando derreter coloque a água com cuidado e mexa até ficar com uma coloração dourada.",
        step6: "Com a calda de caramelo ainda quente espalhe na forma e espere caramelo esfriar.",
        step7: "Depois de frio acrescente a mistura reservada na forma junto a calda.",
        step8: "Coloque a forma dentro de uma maior, acrescente água até a metade e cubra com papel aluminío.",
        step9: "Agora leve para assar na Air Fryer por 20 minutos na temperatura de 180°C.",
