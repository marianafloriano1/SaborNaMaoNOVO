...
export default function soArForno() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "2 bananas \nmaduras congeladas",
    item2: "1 xícara fruta congelada \n(morango, manga, etc.)",
    item3: "1 colher (sopa) de mel ou adoçante (opcional)",
    item4:
      "1/4 xícara de iogurte ou leite (opcional, para deixar mais cremoso)",
  };

  const stepsMap: { [key: string]: string } = {
    step1:
      "Corte as frutas em pedaços e congele por pelo menos 4 horas ou até ficarem firmes.",
    step2:
      "Coloque as frutas congeladas no processador ou liquidificador potente.",
    step3: "Bata até formar um creme liso, parando para mexer se necessário.",
    step4:
      "Adicione mel ou iogurte se quiser uma textura mais suave ou um sabor mais doce.",
    step5:
      "Sirva imediatamente como sorvete tipo soft ou leve ao congelador por 1 hora para firmar mais.",
  };
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/imgSorvNa.jpg")} // Certifique-se de que o caminho está correto
          ...
          <View style={styles.tituloContainer}>
            ...
            <Text style={styles.paragraph}>Sorvete de Fruta</Text>
          </View>
