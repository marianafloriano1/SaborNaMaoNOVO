...
export default function Brigadeiro() {
    ...
    const itemsMap: { [key: string]: string } = {
        item1: "3 berinjelas",
        item2: "Sal e azeite a gosto",
        item3: "1 xícara (chá) de queijo mussarela ralado",
        item4: "500g de carne moída",
        item5: "1 cebola picada",
        item6: "1 tomate picado",
        item7: "1/2 xícara (chá) de azeitona verde picada",
        item8: "1 cenoura ralada",
        item9: "cheiro-verde picado a gosto",
    ...
    const stepsMap: { [key: string]: string } = {
        step1:
            "Lave as berinjelas e corte ao meio, no sentido do comprimento.",
        step2: "Faça cortes superficiais com uma faca sobre a polpa, polvilhe com sal e regue com azeite.",
        step3: "Coloque em uma fôrma e leve ao forno médio (180º C), preaquecido, por 10 minutos.",
        step4: "Retire, deixe amornar, retire parte da polpa com uma colher e reserve. ",
        step5: "Para o recheio, aqueça uma panela com o azeite, em fogo médio, e frite a carne moída e a cebola até dourarem. ",
        step6: "Adicione o tomate, a azeitona, a polpa da berinjela reservada e refogue por 3 minutos. ",
        step7: "Acrescente a cenoura, tempere com sal e cheiro-verde, misture e desligue o fogo. ",
        step8: "Divida o recheio entre as metades das berinjelas, polvilhe com a mussarela e coloque em uma fôrma, uma ao lado da outra.",
        step9: "Leve ao forno médio (180º C), preaquecido, por 10 minutos ou até gratinar. ",
        step10: "Retire e sirva.",
    ...
    const salvarListaDeCompras = async () => {
        ...
        const fileUri =
            FileSystem.documentDirectory + "lista_de_compras_berinjela.txt";
        ...
        <View style={{ flex: 1 }}>
            <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
                <View style={styles.container}>
                    <Image
                        source={require("../assets/images/fundo_berinjela.png")} // Certifique-se de que o caminho está correto
                    ...
                    <View style={styles.tituloContainer}>
                        ...
                        <Text style={styles.paragraph}>BERINJELA RECHEADA COM CARNE MÓIDA</Text>
                    </View>
