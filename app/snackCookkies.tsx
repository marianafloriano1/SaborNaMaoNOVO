      ...
      <View style={styles.container}>
        ...
        <TouchableOpacity onPress={() => toggleCheck("step2")}>
          <Text style={styles.topicos}>
            ...
            Em uma tigela, bata a manteiga com os açúcares até formar um creme.
            Acrescente o ovo e a baunilha e misture bem.
          </Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity onPress={() => toggleCheck("step4")}>
          <Text style={styles.topicos}>
            ...
            Faça bolinhas (de 1 colher de sopa) e coloque na assadeira, deixando
            espaço entre elas (eles espalham).
          </Text>
        </TouchableOpacity>
