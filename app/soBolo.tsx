...
export default function soArForno() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "2 ovos",
    item2: "1 xícara de açúcar",
    item3: "1 xícara de leite",
    item4: "1/2 xícara de óleo",
    item5: "1 xícara de chocolate em pó",
    item6: "2 xícaras de farinha de trigo",
    item7: "1 colher (sopa) de fermento em pó",
  };
  ...
  const stepsMap: { [key: string]: string } = {
    ...
    step2:
      "Em uma tigela, misture os ovos, o açúcar, o leite e o óleo até ficar homogêneo.",
    step3: "Adicione o chocolate em pó e misture bem.",
    step4: "Acrescente a farinha de trigo aos poucos, mexendo sempre.",
    step5: "Por último, adicione o fermento e mexa delicadamente.",
    step6:
      "Despeje a massa na forma e leve ao forno por cerca de 35 a 40 minutos ou até o palito sair limpo.",
    step7: "Deixe esfriar antes de desenformar e servir.",
  };
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/imgBolo.jpg")} // Certifique-se de que o caminho está correto
          ...
          <View style={styles.tituloContainer}>
            ...
            <Text style={styles.paragraph}>Bolo de Chocolate Simples</Text>
          </View>
