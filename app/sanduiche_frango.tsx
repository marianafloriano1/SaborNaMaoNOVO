...
export default function Brigadeiro() {
    ...
    const itemsMap: { [key: string]: string } = {
        item1: "1 colher de sopa de queijo \ncottage",
        item2: "1 colher de sopa de cenoura ralada",
        item3: "sal e pimenta-do-reino a gosto",
        item4: "2 fatias de Pão de Forma Integral da Kim",
        item5: "100 gramas de peito de frango temperado e grelhado (sem óleo)",
        item6: "Brotos de alfafa a gosto (ou folhas de alface)",
        item7: "Fatias de tomate a gosto",
    ...
    const stepsMap: { [key: string]: string } = {
        step1:
            "Reúna todos os ingredientes! Se ainda não tiver o frango pronto, grelhe-o previamente em uma frigideira, sem óleo, até que fique bem cozido e dourado.",
        step2: "Em um processador de alimentos, coloque o queijo cottage, a cenoura ralada, uma pitada de sal e a pimenta-do-reino a gosto. Bata até obter uma mistura homogênea e cremosa.",
        step3: "Pegue as fatias de pão integral e espalhe uma camada generosa dessa pastinha sobre cada uma delas.",
        step4: "Sobre uma das fatias, disponha também os brotos de alfafa ou folhas de alface, o frango grelhado e as fatias de tomate.",
        step5: "Coloque a outra fatia de pão por cima, pressionando levemente para fechar e para que tudo fique bem firme. Sirva e aproveite! Se preferir, corte ao meio para facilitar na hora de comer.",
    ...
    const salvarListaDeCompras = async () => {
        ...
        const fileUri =
            FileSystem.documentDirectory + "lista_de_compras_sanduiche_frango.txt";
        ...
        <View style={{ flex: 1 }}>
            <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
                <View style={styles.container}>
                    <Image
                        source={require("../assets/images/fundo_sanduiche_frango.png")} // Certifique-se de que o caminho está correto
                        style={styles.decorativeImage}
                        resizeMode="contain"
                    />

                    <View style={styles.tituloContainer}>
                        <TouchableOpacity onPress={() => nav.navigate("lanche_rapido")}>
                            <Feather name="chevron-left" size={28} color="#000" />
                        </TouchableOpacity>
                        <Text style={styles.paragraph}>SANDUÍCHE DE FRANGO E COTTAGE</Text>
                    </View>
