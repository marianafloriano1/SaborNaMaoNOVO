...
export default function Brigadeiro() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "1 abacate",
    item2: "1 copo de leite",
    item3: "5 folhas de hortelã",
  ...
  const stepsMap: { [key: string]: string } = {
    step1:
      "Em um liquidificador, coloque todos os ingredientes e bata-os.",
    step2: "Depois, acrescente as duas colheres de açúcar.",
    step3: "Por último, coloque o líquido em um corpo e acrescente algumas pedrinhas de gelo antes de servir.",
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/fundo_vitaVerde.png")} // Certifique-se de que o caminho está correto
          ...
          <View style={styles.tituloContainer}>
            ...
            <Text style={styles.paragraph}>VITAMINA DE ABACATE COM HORTELÃ</Text>
          </View>
