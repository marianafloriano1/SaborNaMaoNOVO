...
export default function soArForno() {
  ...
  const itemsMap: { [key: string]: string } = {
    item1: "1 colher (sopa) \nde açúcar",
    item2: "1 xícara de leite ou água",
    item3: "1/2 xícara de fruta picada\n ou polpa congelada",
    item4: "Forminhas de picolé ou saquinhos para geladinho",
  };

  const stepsMap: { [key: string]: string } = {
    step1:
      "No liquidificador, bata o leite (ou água), o açúcar e a fruta até formar uma mistura homogênea.",
    step2: "Prove e ajuste o açúcar, se necessário.",
    step3:
      "Despeje a mistura em forminhas de picolé ou em saquinhos próprios para geladinho.",
    step4:
      "Leve ao congelador por pelo menos 4 horas ou até congelar completamente.",
    step5: "Desenforme ou corte o saquinho e sirva bem gelado.",
  };
    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
        <View style={styles.container}>
          <Image
            source={require("../assets/images/imgSorvete.jpg")} // Certifique-se de que o caminho está correto
          ...
          <View style={styles.tituloContainer}>
            ...
            <Text style={styles.paragraph}>Picolé ou Geladinho</Text>
          </View>
