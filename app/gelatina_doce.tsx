...
export default function Brigadeiro() {
    ...
    const itemsMap: { [key: string]: string } = {
        item1: "1 pacote de geletina de \nmorango",
        item2: "250 ml de água fria",
        item3: "250 ml de água quente",
    ...
    const stepsMap: { [key: string]: string } = {
        ...
        step2: "Leve à geledeira até endurecer.",
    ...
    const salvarListaDeCompras = async () => {
        ...
        const fileUri =
            FileSystem.documentDirectory + "lista_de_compras_gelatina.txt";
        ...
        <View style={{ flex: 1 }}>
            <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
                <View style={styles.container}>
                    <Image
                        source={require("../assets/images/fundo_gelatina.png")} // Certifique-se de que o caminho está correto
