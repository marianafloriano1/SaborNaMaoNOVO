...
export default function Brigadeiro() {
    ...
    const itemsMap: { [key: string]: string } = {
        item1: "meio pé de alface crespa",
        item2: "meio pé de alface \namericana",
        item3: "1 cenoura ralada",
        item4: "1 beterraba ralada",
        item5: "100 g de mozarela em nós pequenos",
        item6: "Sal e temperos a gosto",
    };

    const stepsMap: { [key: string]: string } = {
        step1:
            "Rasgue as folhas de alface e coloque-as em uma saladeira.",
        step2: "Distribua a cenoura, a beterraba e a mozarela sobre as folhas.",
        step3: "Tempere como preferir sua salada.",
    ...
    const salvarListaDeCompras = async () => {
        ...
        const fileUri =
            FileSystem.documentDirectory + "lista_de_compras_salada.txt";
        ...
        <View style={{ flex: 1 }}>
            <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
                <View style={styles.container}>
                    <Image
                        source={require("../assets/images/fundo_salada_rapida.png")} // Certifique-se de que o caminho está correto
                    ...
                    <View style={styles.tituloContainer}>
                        ...
                        <Text style={styles.paragraph}>SALADA RÁPIDA</Text>
                    </View>
