...
export default function Brigadeiro() {
    ...
    const itemsMap: { [key: string]: string } = {
        ...
        item2: "1/2 xícara de agua",
        item3: "Tempero completo (tipo sabor ami)",
        item4: "1 pitada de pimenta do reino",
        item5: "5 filés de frango",
        item6: "1 e 1/2 xícaras de farinha de rosca",
        item7: "Óleo para fritar",
    ...
    const salvarListaDeCompras = async () => {
        ...
        const fileUri =
            FileSystem.documentDirectory + "lista_de_compras_frango_empanado.txt";
        ...
        <View style={{ flex: 1 }}>
            <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
                <View style={styles.container}>
                    <Image
                        source={require("../assets/images/fundo_fango.png")} // Certifique-se de que o caminho está correto
                    ...
                    <View style={styles.tituloContainer}>
                        ...
                        <Text style={styles.paragraph}>FRANGO EMPANADO SEM OVO</Text>
                    </View>
